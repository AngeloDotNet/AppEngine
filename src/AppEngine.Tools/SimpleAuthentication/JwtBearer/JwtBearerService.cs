...
using System.Text;
using AppEngine.Tools.SimpleAuthentication.Abstractions;
...
public class JwtBearerService(IOptions<JwtBearerSettings> jwtBearerSettingsOptions) : IJwtBearerService
{
    ...
    public virtual Task<string> CreateTokenAsync(string userName, IList<Claim>? claims = null, string? issuer = null, string? audience = null,

...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddDefaultFusionCache(this IServiceCollection services, Action<FusionCacheEntrySettings> action)
    {
    ...
    public static IServiceCollection AddDistributedFusionCache(this IServiceCollection services,
        Action<FusionCacheEntrySettings> action, Action<FusionCacheDistributedSettings> distributedAction)
    {
        ArgumentNullException.ThrowIfNull(services);
        ArgumentNullException.ThrowIfNull(action);
    ...
    public static IServiceCollection AddDistributedOptionsFusionCache(this IServiceCollection services, Action<FusionCacheEntrySettings> action,
    ...
    /// be null.</param>
    /// <returns>The same IServiceCollection instance so that additional calls can be chained.</returns>
    public static IServiceCollection AddDistributedJitterFusionCache(this IServiceCollection services, Action<FusionCacheEntrySettings> action,
        Action<FusionCacheDistributedSettings> distributedAction, IOptions<FusionCacheDistributedOptions> options)
    {
        ArgumentNullException.ThrowIfNull(services);
        ArgumentNullException.ThrowIfNull(action);
    ...
    internal static IServiceCollection AddFusionCacheWithoutBackplane(this IServiceCollection services, FusionCacheEntrySettings configuration,
    ...
    internal static IServiceCollection AddFusionCacheWithBackplane(this IServiceCollection services, FusionCacheEntrySettings configuration,
        FusionCacheDistributedSettings distributedSettings, FusionCacheDistributedOptions cacheOptions)
    {
        services.AddFusionCache()
            .WithOptions(options =>
    ...
    internal static async Task<IServiceCollection> AddFusionCacheDistributedStampedeProtectionAsync(this IServiceCollection services,
        FusionCacheEntrySettings configuration, FusionCacheDistributedSettings distributedSettings, FusionCacheDistributedOptions cacheOptions)
    {
        ...
        services.AddFusionCache()
            ...
            //.WithDistributedLocker(new RedisDistributedLocker(new RedisDistributedLockerOptions { Configuration = distributedSettings.RedisConnectionString }))
    ...
    internal static async Task<IServiceCollection> AddFusionCacheDistributedStampedeLoggingAsync(this IServiceCollection services,
        FusionCacheEntrySettings configuration, FusionCacheDistributedSettings distributedSettings, FusionCacheDistributedOptions cacheOptions)
    {
        // Create a single instance of ConnectionMultiplexer to be shared across the application
        // This is important for performance and resource management when using StackExchange.Redis (Optimize Redis Usage)
